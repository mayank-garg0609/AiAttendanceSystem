...
async def mark_attendance(course_id: int, photo: UploadFile = File(...), db: Session = Depends(get_db)):
    try:
        # Read image bytes
        ...
        return {
            ...
            "present_students": student_ids_present 
        }
    

    except Exception as e:
        print("Error in mark_attendance:", str(e))
        raise HTTPException(status_code=500, detail="AI Model failed to process the image")
